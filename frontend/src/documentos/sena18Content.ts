...
export const SENA18_NOTAS = {
  ...
  // Reescrita a pedido (ya no es la del Excel): pide CUATRO colores, que son
  // los renglones que tiene el papel. El salto de renglón es intencional.
  colores:
    'EL CLIENTE DEBERÁ SELECCIONAR CUATRO (4) COLORES, INDICANDO EL ORDEN DE PRIORIDAD SEGÚN SU PREFERENCIA.\nEN CASO DE SOLICITAR UN COLOR ESPECÍFICO, EL CLIENTE DECLARA CONOCER Y ACEPTAR QUE, SI DICHO COLOR NO SE ENCUENTRA DISPONIBLE, LA SOLICITUD PODRÁ AFECTAR EL PLAZO DE ENTREGA DEL EQUIPO/PRODUCTO.',
  plazo:
