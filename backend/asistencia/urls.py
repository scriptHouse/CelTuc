...
urlpatterns = [
    ...
    path('control-sucursales/', views.ControlSucursalListView.as_view(),
         name='control-sucursales'),
    path('control-sucursales/<int:pk>/', views.ControlSucursalDetailView.as_view(),
         name='control-sucursal'),
    ...
    path('sucursales-empleado/', views.AsignacionSucursalListCreateView.as_view(),
         name='asignaciones-sucursal'),
    path('sucursales-empleado/<int:pk>/', views.AsignacionSucursalDetailView.as_view(),
    ...
    path('empleados/<int:pk>/', views.LegajoEmpleadoView.as_view(), name='legajo-empleado'),
    path('inconsistencias/', views.InconsistenciasView.as_view(), name='inconsistencias'),
    path('inconsistencias/resolver/', views.ResolverInconsistenciaView.as_view(),
         name='inconsistencia-resolver'),
    path('inconsistencias/catalogo/', views.CatalogoInconsistenciasView.as_view(),
         name='inconsistencias-catalogo'),
    path('reglas/', views.ReglaListCreateView.as_view(), name='reglas'),
    path('reglas/sembrar/', views.ReglasSembrarView.as_view(), name='reglas-sembrar'),
    path('reglas/<int:pk>/', views.ReglaDetailView.as_view(), name='regla'),
